...
describe("BlackjackGame", () => {
  ...
  describe("initialization", () => {
    ...
    it("should reject more than 7 players", () => {
      for (let i = 0; i < 7; i++) game.addPlayer(`p${i}`, `Player${i}`);
      expect(() => game.addPlayer("p8", "Overflow")).toThrow("Maximum 7 players allowed");
    });
  ...
  describe("betting phase", () => {
    ...
    it("should place bet within chips", () => {
      ...
      expect(game.getState().players[0].bet).toBe(100);
    });
  ...
  describe("player actions", () => {
    ...
    it("should hit and add card to hand", () => {
      ...
      expect(game.getState().players[0].hands[0].length).toBe(initialCount + 1);
    });
  ...
  describe("dealer phase", () => {
    ...
    it("should move to resolution after dealer turn", () => {
      ...
      game.playerAction("p2", "stand");
      game.playDealer();
      expect(game.getState().phase).toBe("resolution");
    });
  });
